...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between px-12 py-6 bg-black/95 backdrop-blur-md border-b border-[#1a1a1a]">
      ...
      {/* BRAND */}
      <h1 className="text-3xl font-serif tracking-[6px] text-[#c8a96a] drop-shadow-md">
        LUXOREE
      </h1>
      ...
      {/* CTA BUTTON */}
      <Link to="/products">
        <button className="px-5 py-2 border border-[#c8a96a] text-[#c8a96a] text-sm uppercase tracking-[2px] hover:bg-[#c8a96a] hover:text-black transition duration-300">
          Shop Now
        </button>
      </Link>
